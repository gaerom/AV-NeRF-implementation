...
#     parser.add_argument('--log-dir', type=str, default="logs_GT/")
...
#     model = ANeRF(conv=args.conv, p=args.p) # A-NeRF training 
#     model.to(device)
...
def parse_args():
    ...
    # dataset
    parser.add_argument('--data-root', type=str, default="SoundSpaces")
    parser.add_argument('--no-position', action="store_true")
    parser.add_argument('--no-orientation', action="store_true")
